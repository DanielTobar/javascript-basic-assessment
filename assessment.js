...
function doubleTheFun(parameter){
  if(isNaN(parameter) === true){parameter = parameter + parameter;}
  else {
...
function makeChatMessage(string1, string2){
  object = {
    menssage:string1 ,
    author: string2,
    timestamp:  function(){string1.getTime();}
  };
  return object;
}
